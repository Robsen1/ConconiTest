...
public class MainActivity extends Activity {
    ...
    public static final int STORE_PERIOD = 50; //interval for storing the data in meter
...
//            TextView log3 = (TextView) findViewById(R.id.mainActivity_text_speedActual);
//
...
//            log3.setText(String.valueOf(mStartspeed + mDistance / 200 * 0.5f));
//
